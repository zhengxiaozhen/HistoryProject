    ...
    function getHtml(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0) {
                ulHtml += '<a href="javascript:;" data-default="'+data[i].defaulturl+'" class="second-menu">';
                ...
                for (var j = 0; j < data[i].children.length; j++) {
                    ...
                    ulHtml += '<a href="javascript:;" data-url="' + data[i].children[j].href + '" data-target="'+data[i].children[j].target+'">';
			...
			//不存在子菜单 
                ...
                ulHtml += '<a href="javascript:;" ' + dataUrl + ' data-target="'+data[i].target+'">';
                if (data[i].icon !== undefined && data[i].icon !== '') {
                    if (data[i].icon.indexOf('fa-') !== -1) {
                        ulHtml += '<i class="fa ' + data[i].icon + '" aria-hidden="true" data-icon="' + data[i].icon + '"></i>';
                    } else {
