...
var gcGray = "#808080";		//不在当月日期显示颜色
var gcToggle = "gold";		//鼠标经过单元格背景
var gcred = "#FF0000";		//高亮显示颜色
var gcBG = "#f0f0f0";		//日历表格背景
var gcGreen = "darkGreen";
var gcLine="silver";		//日历表边框颜色
var gcTitle="silver";		//日历表头部背景
var ofSize="10pt";			//无意义
...
var gMonths = new Array("一","二","三","四","五","六","七","八","九","十","十一","十二");
...
write("<TR>");
write("<td valign='middle' align='center'><input type='button' name='PrevMonth' value='<<' onClick='fPrevMonth()'>");
